...
const Contact = () => {
  return (
    <section id="contact" className="min-h-screen py-20 bg-dark-surface">
            ...
            >
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="https://github.com/atgAtharvGupta" className="text-gray-400 hover:text-accent transition-colors duration-300">
                  ...
                  <a href="https://www.linkedin.com/in/atharv-gupta-65b755259/" className="text-gray-400 hover:text-accent transition-colors duration-300">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
